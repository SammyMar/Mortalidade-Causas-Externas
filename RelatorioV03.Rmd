...
#DATAFRAME
df1 <- read_csv("Obitos_gest_puerp_causas_externas_2011_2021.csv")
df2 <- read_csv("Obitos_nao_gest_puerp_causas_externas_2011_2021.csv")
df1$gestante <- TRUE
df2$gestante <- FALSE
...
define_keywords(title.dfSummary = "Table 2: Frequência das variáveis em estudo",
                dimensions = "Dimensões",
                duplicates = 'Duplicadas',data.frame ='Dados disponíveis',
                variable= 'Variáveis',valid = 'Válidos',
                stats.values = 'Estatísticas/Valores',
                freqs.pct.valid= 'Freq. De Válidos',
                graph= 'Gráficos',missing= 'Faltantes',
                distinct.value = 'Valores Distintos',
